...
const processData = {
    title:"How it works",
    descritption:"Fresh fellow even the whole is work outcome them. They original on mountains, drew the support time. The of to graduate. Into to is the to she at return understand.",
    imageCover:"/vector-18.png",
    linkTo:"/",
    videoLink:"https://www.youtube.com/embed/F-1weFCiYBA",
}

class VideoComponent6 extends React.Component {
                          ...
                          <div className="col-md-5 mr-auto text-center text-md-left">
                            <BlogCard>
                                ...
                                <Media  onClick={this.openModal}>
                                    ...
                                    <CallToAction>PLAY THE VIDEO</CallToAction>
                                </Media>
...
VideoComponent6.propTypes = {
  
}

VideoComponent6.defaultProps = {
  
}

export default VideoComponent6