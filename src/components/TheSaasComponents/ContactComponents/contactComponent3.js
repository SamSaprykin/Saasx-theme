                    ...
                    <StyledForm className="col-11 col-lg-12">
                        <StyledRow>
                            <FormGroup className="col-md-6">
                                <StyledInput type="text" id="name" name="name"  placeholder="First Name" required />
                            </FormGroup>
                            <FormGroup className="col-md-6">
                                <StyledInput type="text" id="name" name="name"  placeholder="Last Name" required />
                            </FormGroup>
                        </StyledRow>
                        <StyledRow>
                            <FormGroup className="col-md-6">
                                <StyledInput type="text" id="name" name="name"  placeholder="Email" required />
                            </FormGroup>
                            <FormGroup className="col-md-6">
                                <StyledInput type="text" id="name" name="name"  placeholder="Phone" required />
                            </FormGroup>
                        </StyledRow>
                        <StyledRow>
                            <FormGroup className="col-md-12">
                                <StyledTextArea id="message" name="message" cols="30" rows="5"  placeholder="What do you have in mind?" required></StyledTextArea>
                            </FormGroup>
                            <FormGroup className="col-md-12">
...
ContactComponents3.propTypes = {
  
}

ContactComponents3.defaultProps = {
  
}

export default ContactComponents3