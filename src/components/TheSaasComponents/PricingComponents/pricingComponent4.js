                        ...
                        pricingData.cards.map((card,index) => {
                            return (
                                <div className="col-md-4">
                                    <Card 
                                    className={card.bestChoice === true ? "gray" : ""}
                                    color={card.color}>
                                        
                                        {
                                            card.bestChoice  === true && <PopulatTag>best choice </PopulatTag>
                                        }
                                        <CardHeader>
                                            {card.title}
                                        </CardHeader>
...
PricingComponent4.propTypes = {
  
}

PricingComponent4.defaultProps = {
  
}

export default PricingComponent4